...
namespace SkateWorld.FinalCharacterController
{
    ...
    public class PlayerStateMachine : MonoBehaviour
    {
        ...
        public int IsMountingHash { get { return _isMountingHash; } }
        public int IsDismountingHash {  get { return _isDismountingHash; } }
        ...
        void Awake()
        {
            ...
            _isMountingHash = Animator.StringToHash("isMounting");
            _isDismountingHash = Animator.StringToHash("isDismounting");
        ...
        void Update()
        {
            ...
            //Debug.Log("START:    " + Ctx.AppliedMovementX);
            //Debug.Log("START:    " + Ctx.AppliedMovementZ);

            
            if (_isMountedPressed)
            {
                Debug.Log("mount pressed");
                Debug.Log("START:    " + _appliedMovement);
        ...
        IEnumerator WaitThingy()
        {
            ...
            Debug.Log("             can mount again");
            _isMountedPressed = false;
